...
public struct LineChartView: View {
    ...
    @AppStorage("currentValue") private var currentValue: Double = 2 {
        didSet{
    ...
    var frame = CGSize(width: UIScreen.main.bounds.width / 1.1, height:100)
    ...
    public init(data: [Double],
        ...
        self.formSize = form!
        frame = CGSize(width: UIScreen.main.bounds.width / 1.1, height:70)
    ...
    public var body: some View {
        ZStack(alignment: .center){
            RoundedRectangle(cornerRadius: 20)
                ...
                .frame(width:320, height: 0, alignment: .center)
        ...
        .onChanged({ value in
            ...
            .onEnded({ value in
                ...
                if(Double(AbsoluteTotal) != nil){
                    self.currentValue = Double(AbsoluteTotal)!
                }
