...
public struct Colors {
    ...
    public static let GradientUpperYellow:Color = Color(hexString: "#FFF07B")
    public static let AppleYellowBackground:Color = Color(hexString: "#F7CE45")
...
public struct ChartForm {
    ...
    public static let medium = CGSize(width: UIScreen.main.bounds.width / 1.1, height:70)
